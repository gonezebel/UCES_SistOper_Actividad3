...
def introduction_view() -> None:
    ...
    image_path = Path(__file__).parent / "02_Imagenes" / "04_introduccion_sin_footer.png"
    if not image_path.exists():
        st.error("No se encontró la imagen de introducción en 02_Imagenes/04_introduccion_sin_footer.png.")
        return
    encoded = base64.b64encode(image_path.read_bytes()).decode("ascii")
    st.markdown(
        f"""
